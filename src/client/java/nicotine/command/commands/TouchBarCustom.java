...
public class TouchBarCustom {


    final public static LinkedHashMap<String, String> customTouchBarItems = new LinkedHashMap<>();

    public static void init() {
        Command touchBar = new Command("touchbar", "Add custom items to the touch bar (.touchbar <add/remove> <mod/command> <btn name> <mod name / command args>)") {
            @Override
        ...
        CommandManager.addCommand(touchBar);
    }
}
